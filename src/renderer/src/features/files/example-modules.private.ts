 ...
 */
export const privateManifestModules = import.meta.glob('@examples/private/index.json', {
  eager: true,
  import: 'default'
}) as Record<string, unknown>

export const privateFlowModules = import.meta.glob('@examples/private/*.flow.json', {
  eager: true,
  import: 'default'
}) as Record<string, unknown>
